...
namespace tsorcRevamp.Buffs
{
    public class PowerWithin : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            player.GetDamage(DamageClass.Generic) *= 1f + Content.Items.Tools.PowerWithin.DamageIncrease / 100f;
            ...
            player.GetModPlayer<tsorcRevampStaminaPlayer>().staminaResourceGainMult += Content.Items.Tools.PowerWithin.StaminaRegen / 100f;
