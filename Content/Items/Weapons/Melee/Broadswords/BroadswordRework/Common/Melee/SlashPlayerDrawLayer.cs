...
using tsorcRevamp.Content.Items.Weapons.Melee.Broadswords.BroadswordRework.Common.TextureColors;
...
public class SlashPlayerDrawLayer : PlayerDrawLayer
{
    ...
    protected override void Draw(ref PlayerDrawSet drawInfo)
    {
        ...
        float visualScale = MathHelper.Max(0.05f,
            item.GetGlobalItem<global::tsorcRevamp.Content.Items.tsorcInstancedGlobalItem>().slashVisualScale);
