...
using Hook = tsorcRevamp.Content.Items.Weapons.Melee.Broadswords.BroadswordRework.Common.Hooks.Items.ICanMeleeCollideWithNPC;

namespace tsorcRevamp.Content.Items.Weapons.Melee.Broadswords.BroadswordRework.Common.Hooks.Items;
