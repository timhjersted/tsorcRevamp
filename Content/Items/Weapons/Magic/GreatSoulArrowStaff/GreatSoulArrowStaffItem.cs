...
namespace tsorcRevamp.Content.Items.Weapons.Magic.GreatSoulArrowStaff
{
    ...
    class GreatSoulArrowStaffItem : ModItem
    {
        ...
        public override string Texture => UsefulFunctions.RefactorableFilepath(typeof(SoulArrowStaff));
        ...
        public override bool Shoot(Player player, Terraria.DataStructures.EntitySource_ItemUse_WithAmmo source, Vector2 position, Vector2 speed, int type, int damage, float knockBack)
        {
            ...
            {
                Projectile.NewProjectile(player.GetSource_ItemUse(Item), new Vector2(position.X, position.Y), new Vector2(mySpeedX, mySpeedY), ModContent.ProjectileType<Projectiles.GreatSoulArrow>(), damage, knockBack, player.whoAmI);
            }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<SoulArrowStaff>());
            recipe.AddIngredient(ModContent.ItemType<DarkSoulItem>(), 3000);
            recipe.AddIngredient(ModContent.ItemType<Potions.SoulSiphonPotion>());
