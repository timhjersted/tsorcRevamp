...
namespace tsorcRevamp.Content.Items.Accessories.Other.SoulReaper
{
    ...
    public class SoulReaper2Item : ModItem
    {
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<Other.SoulReaper.SoulReaper>(), 1);
        ...
        {
            player.GetModPlayer<DarkSoulPlayer>().SoulPickupRange += 10;
            player.GetModPlayer<DarkSoulPlayer>().ConsSoulChanceMult += ConsSoulChanceAmp / 5;
