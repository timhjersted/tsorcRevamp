...
namespace tsorcRevamp.Content.Items.BossBags
{
    ...
    public class PinwheelBag : BossBag
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<MaskOfTheChild>()));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<MaskOfTheMother>()));
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<MaskOfTheFather>()));
    ...
    public class SlograBag : BossBag
    {
        ...
        public override void ModifyItemLoot(ItemLoot itemLoot)
        {
            ...
            itemLoot.Add(ItemDropRule.Common(ModContent.ItemType<BloodbaneRing>()));
