...
namespace tsorcRevamp.Content.Projectiles.Melee.Boomerangs
{
    class ShatteredMoonlightProjectile : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            if (Projectile.ai[0] == 2)
            {
                ...
                for (int i = 0; i < 10; i++)
                {
                    Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 89, 0, 0, 0, default(Color), 1f);
                }
            }
        }
    }
