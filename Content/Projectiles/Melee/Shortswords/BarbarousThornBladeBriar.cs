...
{
    class BarbarousThornBladeBriar : ModProjectile
    {
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            owner.statLife += BarbarousThornBlade.Heal;
            owner.HealEffect(BarbarousThornBlade.Heal);
        }
        ...
        {
            modifiers.ScalingArmorPenetration += BarbarousThornBlade.ArmorPen / 100f;
        }
