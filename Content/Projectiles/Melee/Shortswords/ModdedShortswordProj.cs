...
namespace tsorcRevamp.Content.Projectiles.Melee.Shortswords;

public abstract class ModdedShortswordProj : ModProjectile
{
    public abstract float HitboxWidth { get; }
    public abstract float HitboxLength { get; }
    ...
    public virtual float SetDefaultScale()
    {
        return 1f;
    }
    ...
    public virtual void Initialization(Player player)
    {
        ...
        CollisionWidth = HitboxWidth * Projectile.scale;
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.scale = SetDefaultScale();
        }
        ...
        public override void CutTiles()
        {
            ...
            Vector2 end = start + Projectile.velocity.SafeNormalize(-Vector2.UnitY) * HitboxLength * player.GetAdjustedItemScale(player.HeldItem);
        ...
        public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
        {
            ...
            Vector2 start = Projectile.Center;
            Vector2 end = start + Projectile.velocity * HitboxLength * player.GetAdjustedItemScale(player.HeldItem);
