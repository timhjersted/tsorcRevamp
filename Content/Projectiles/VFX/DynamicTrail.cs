...
namespace tsorcRevamp.Content.Projectiles.VFX
{
    public class DynamicTrail : ModProjectile
    {
        ...
        public override string Texture => UsefulFunctions.RefactorableFilepath(typeof(DynamicTrail));
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (visualizeTrail)
            {
                ...
                {
                    starTexture = (Texture2D)ModContent.Request<Texture2D>(UsefulFunctions.RefactorableFilepath(typeof(HomingStarStar)), ReLogic.Content.AssetRequestMode.ImmediateLoad);
                }
