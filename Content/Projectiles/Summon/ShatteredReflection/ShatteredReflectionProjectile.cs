...
namespace tsorcRevamp.Content.Projectiles.Summon.ShatteredReflection
{
    public class ShatteredReflectionProjectile : ModProjectile
    {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<ShatteredReflectionBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<ShatteredReflectionBuff>()))
            {
