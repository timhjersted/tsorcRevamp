...
namespace tsorcRevamp.Content.Projectiles.Summon.Sentry
{
    class XBowArrow : DynamicTrail
    {
        ...
        {
            SoundEngine.PlaySound(new SoundStyle("tsorcRevamp/Sounds/Runeterra/Summon/GaleforceHit") with { Volume = 0.4f }, target.Center);
        }
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            modifiers.ArmorPenetration += XBow.ArmorPen;
        }
        ...
        public override void SetEffectParameters(Effect effect)
        {
            ...
            effect.Parameters["shaderColor"].SetValue(new Color(0.9f, 0.9f, 0.9f, 1f).ToVector4());
