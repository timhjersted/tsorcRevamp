...
namespace tsorcRevamp.Content.Projectiles.Summon.YoungHunter
{
    class YoungHunterVine : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = 65; //this projectile actually uses its timeLeft value. the final set of vines lasts longer, so we need to do the kill check differently
            Projectile.netUpdate = true;
            Projectile.DamageType = DamageClass.Summon;
            Projectile.ArmorPenetration = 20;
            Projectile.usesIDStaticNPCImmunity = true;
            Projectile.idStaticNPCHitCooldown = 66;
        }

        private const int AI_Split_Counter_Slot = 0;
        private const int AI_Timer_Slot = 1;

        private const int AI_Max_Splits = 1; //the exponent. projectile can split this many times. this counter is remembered for a projectile's children.
        ...
        public override void AI()
        {
            ...
            speedMod = RotateAboutOrigin(speedMod, (float)((Math.PI * z2) / 30f)); //the 38f controls the curve strength. too low and the projectile spins in circles
