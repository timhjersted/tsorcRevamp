...
namespace tsorcRevamp.Content.Projectiles.Enemy.Marilith
{
    class MarilithFireball : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (target != null)
            {
                ...
                Vector2 targetVel = UsefulFunctions.Aim(Projectile.Center, target.Center + (target.velocity * time), 16);
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            {
                Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center + Main.rand.NextVector2CircularEdge(24, 24), Vector2.Zero, ModContent.ProjectileType<MarilithFirestorm>(), Projectile.damage, 0, Main.myPlayer, Projectile.ai[0]);
            }
        }
