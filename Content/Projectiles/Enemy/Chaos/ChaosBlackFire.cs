...
namespace tsorcRevamp.Content.Projectiles.Enemy.Chaos
{
    ...
    {
        public override string Texture => UsefulFunctions.RefactorableFilepath(typeof(EnemyBlackFire));
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.rand.NextBool(5))
                {
                    ...
                    int lol = Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, 27, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 160, default(Color), 3f);
