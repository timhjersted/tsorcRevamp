        ...
        public override void Kill(int timeLeft) {
            ...
            projectile.timeLeft = 0;
            {
                ...
                for (int num40 = 0; num40 < 20; num40++) {
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 0, ModContent.ProjectileType<Explosion>(), 25, 8f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width * 4), projectile.position.Y + (float)(projectile.height), 0, 0, ModContent.ProjectileType<Explosion>(), 25, 8f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width * -2), projectile.position.Y + (float)(projectile.height), 0, 0, ModContent.ProjectileType<Explosion>(), 25, 8f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height * -2), 0, 0, ModContent.ProjectileType<Explosion>(), 25, 8f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height * 4), 0, 0, ModContent.ProjectileType<Explosion>(), 25, 8f, projectile.owner);
