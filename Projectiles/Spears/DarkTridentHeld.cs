...
class DarkTridentHeld : ChargedBowHeld {
    ...
    protected override void Shoot()
    {
        ...
        else
        {
            ...
            Projectile.NewProjectile(player.GetSource_ItemUse(player.inventory[player.selectedItem]), Projectile.Center, velVector, ModContent.ProjectileType<Projectiles.Spears.DarkTridentPoke>(), maxDamage / 6, Projectile.knockBack, Projectile.owner);
        }
    }
