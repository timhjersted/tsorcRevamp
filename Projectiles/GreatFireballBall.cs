    ...
    class GreatFireballBall : ModProjectile {
		...
		public override void Kill(int timeLeft) {
			...
			projectile.timeLeft = 0;
			{
				...
				if (projectile.owner == Main.myPlayer) Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 0, ModContent.ProjectileType<GreatFireball>(), (int)(32 * (Main.player[projectile.owner].magicDamage)), 6f, projectile.owner);
