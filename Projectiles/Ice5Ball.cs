        ...
        public override void Kill(int timeLeft) {
            ...
            projectile.timeLeft = 0;
            {
                ...
                for (int num40 = 0; num40 < 20; num40++) {
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 5, ModContent.ProjectileType<Ice5Icicle>(), (int)(this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width * 4), projectile.position.Y + (float)(projectile.height * 2), 0, 5, ModContent.ProjectileType<Ice5Icicle>(), (int)(this.projectile.damage), 3f, projectile.owner);
                    Projectile.NewProjectile(projectile.position.X + (float)(projectile.width * -2), projectile.position.Y + (float)(projectile.height * 2), 0, 5, ModContent.ProjectileType<Ice5Icicle>(), (int)(this.projectile.damage), 3f, projectile.owner);
