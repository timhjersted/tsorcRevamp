...
namespace tsorcRevamp.Projectiles.Pets
{
    class MiakodaFull : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //Lighting.AddLight(projectile.position, .0f, .25f, .35f);
            ...
            if (modPlayer.MiakodaFullTimer > 600)
            {
                {
            ...
            if (modPlayer.MiakodaFullTimer == 600) //sound effect the moment the timer reaches 420, to signal pet ability ready.
            {
                string[] ReadySoundChoices = new string[] { "Sounds/Custom/MiakodaChaaa", "Sounds/Custom/MiakodaChao", "Sounds/Custom/MiakodaDabudab", "Sounds/Custom/MiakodaDootdoot", "Sounds/Custom/MiakodaHi", "Sounds/Custom/MiakodaOuuee" };
