    ...
    class PulsarShot : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            ...
            else //(projectile.owner == Main.myPlayer && projectile.timeLeft <= 51)
            {
                ...
                //Main.PlaySound(mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/pulsarboom").WithVolume(.9f).WithPitchVariance(.2f));
                for (int i = 0; i < 110; i++)
                {
        ...
        public override void AI()
        {
            ...
            if (projectile.owner == Main.myPlayer && projectile.timeLeft == 51)
            {
                ...
                //Main.PlaySound(mod.GetLegacySoundSlot(SoundType.Item, "Sounds/Item/pulsargrow").WithVolume(.9f).WithPitchVariance(.2f));
            }
