    ...
    class EnemySpellSuddenDeathBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.timeLeft = 0;
            {
                ...
                if (Projectile.owner == Main.myPlayer) Projectile.NewProjectile(Projectile.position.X + (float)(Projectile.width / 2), Projectile.position.Y + (float)(Projectile.height - 16), 0, 0, ModContent.ProjectileType<Projectiles.Enemy.EnemySpellSuddenDeathStrike>(), Projectile.damage, 3f, Projectile.owner);
