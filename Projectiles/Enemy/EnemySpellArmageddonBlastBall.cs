    ...
    class EnemySpellArmageddonBlastBall : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            Projectile.timeLeft = 0;
            {
                ...
                if (Projectile.owner == Main.myPlayer) Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.position.X + (float)(Projectile.width * +3f), Projectile.position.Y + (float)(Projectile.height * +5.5f), 0, 0, ModContent.ProjectileType<Projectiles.Enemy.EnemySpellArmageddonBlast>(), Projectile.damage, 8f, Projectile.owner);
