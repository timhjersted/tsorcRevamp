...
{
    class ChaosBlackFirelet : ModProjectile
    {
            ...
            else
            {
                ...
                else
                {
                    for (int num42 = 0; num42 < 2; num42++)
                    {
                        ...
                        int dust = Dust.NewDust(new Vector2(Projectile.position.X, Projectile.position.Y), Projectile.width, Projectile.height, 27, Projectile.velocity.X * 0.2f, Projectile.velocity.Y * 0.2f, 100, default(Color), 2f);
