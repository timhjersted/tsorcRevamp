    ...
    public class IncineratingGaze : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (chargeProgress < firingTime)
            {
                ...
                {
                    targetingData = new ArmorShaderData(ModContent.Request<Effect>("tsorcRevamp/Effects/IncineratingGazeTargeting"), "IncineratingGazeTargetingPass");
                }
                ...
                Main.EntitySpriteDraw(tsorcRevamp.NoiseTurbulent, Projectile.Center - Main.screenPosition, targetingSourceRectangle, Color.White, Projectile.rotation, targetingOrigin, Projectile.scale, targetingSpriteEffects, 0);
            }
            ...
            if (data == null)
            {
                data = new ArmorShaderData(ModContent.Request<Effect>("tsorcRevamp/Effects/IncineratingGaze"), "IncineratingGazePass");
            }
