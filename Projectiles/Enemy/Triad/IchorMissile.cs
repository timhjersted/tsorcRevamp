    ...
    class IchorMissile : ModNPC
    {
        ...
        public override void AI()
        {
            if (!spawnedTrail)
            {
                ...
                {
                    Projectile.NewProjectileDirect(NPC.GetSource_FromThis(), NPC.Center, NPC.velocity, ModContent.ProjectileType<Projectiles.Enemy.Triad.IchorTrail>(), 0, 0, Main.myPlayer, 1, NPC.whoAmI);
                }
                spawnedTrail = true;
            }
