...
namespace tsorcRevamp.Projectiles.VFX
{
    ...
    class FireTeleportBlast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            // Smoke ring: 30 evenly-spaced particles with a slight spiral twist
            for (int i = 0; i < 30; i++)
            {
            ...
            // Fire ring: 20 particles staggered between the smoke spokes
            for (int i = 0; i < 20; i++)
            {
                ...
                Dust fire = Dust.NewDustPerfect(
                    Projectile.Center + dir * Main.rand.NextFloat(3f, 14f),
                    DustID.Torch, dir * speed,
                    50, new Color(255, 155, 45), Main.rand.NextFloat(1.8f, 2.8f));
                fire.noGravity = true;
                fire.fadeIn = 0.9f;
            }
        }
