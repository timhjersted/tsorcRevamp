...
namespace tsorcRevamp.Projectiles.VFX
{
    ...
    class AbyssTeleportMistLinger : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                if (isFire)
                {
                    ...
                    {
                        Dust fire = Dust.NewDustPerfect(Projectile.Center + offset, DustID.PinkTorch, velocity, 180, new Color(255, 100, 20), Main.rand.NextFloat(1.7f, 2.55f));
                        fire.noGravity = true;
                        fire.fadeIn = 0.6f;
                    }
                    else
                ...
                {
                    Dust smoke = Dust.NewDustPerfect(Projectile.Center + offset, DustID.Smoke, velocity * 0.4f, 180, new Color(130, 130, 130), Main.rand.NextFloat(1.6f, 2.6f));
                    smoke.noGravity = true;
                    smoke.fadeIn = 0.5f;
                }
            }
