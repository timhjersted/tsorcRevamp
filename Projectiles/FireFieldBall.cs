                ...
                if (Main.player[projectile.owner].channel) {
                    ...
                    if (projectile.ai[0] == 0f) {
                        ...
                        if (projectile.velocity.X == 0f && projectile.velocity.Y == 0f) {
                            projectile.Kill();
                            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width), projectile.position.Y + (float)(projectile.height), 0, 0, ModContent.ProjectileType<FireField>(), 30, 3f, projectile.owner);
                        }
                    }
                }
            }
