...
namespace tsorcRevamp.Projectiles.Melee.Shortswords
{
	...
	public class ClaiomhSolaisProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			SetVisualOffsets();
            int dust = Dust.NewDust(new Vector2(Projectile.Hitbox.X, Projectile.Hitbox.Y), Projectile.Hitbox.Width, Projectile.Hitbox.Height, 15, player.velocity.X * 0.2f + player.direction * 3, player.velocity.Y * 0.2f, 100, default, 1.0f);
		...
		private void SetVisualOffsets()
		{
			...
			const int HalfSpriteHeight = 68 / 2;
		...
		public override bool? Colliding(Rectangle projHitbox, Rectangle targetHitbox)
		{
			...
			Vector2 start = Projectile.Center;
			Vector2 end = start + Projectile.velocity * 16f;
