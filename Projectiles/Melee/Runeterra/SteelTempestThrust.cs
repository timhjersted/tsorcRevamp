...
namespace tsorcRevamp.Projectiles.Melee.Runeterra
{
	public class SteelTempestThrust : ModProjectile
	{
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            {
				Hit = true;
                SoundEngine.PlaySound(new SoundStyle("tsorcRevamp/Sounds/Runeterra/Melee/SteelTempest/ThrustHit") with { Volume = 1f });
            }
        }
        public override void Kill(int timeLeft)
        {
            ...
            if (Hit)
            {
                ...
                {
                    SoundEngine.PlaySound(new SoundStyle("tsorcRevamp/Sounds/Runeterra/Melee/SteelTempest/TornadoReady") with { Volume = 1f });
                }
            }
        }
    }
