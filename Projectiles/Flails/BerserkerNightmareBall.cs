...
namespace tsorcRevamp.Projectiles.Flails;
	...
	public class BerserkerNightmareBall : ModProjectile
	{
		...
		private const string ChainTexturePath = "tsorcRevamp/Projectiles/Flails/BerserkerNightmareChain"; // The folder path to the flail chain sprite
		private const string ChainTextureExtraPath = "tsorcRevamp/Projectiles/Flails/BerserkerNightmareChain2";  // This texture and related code is optional and used for a unique effect
		...
		public override void AI()
		{
			...
			float launchSpeed = 23f; // How fast the projectile can move
