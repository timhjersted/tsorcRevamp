    ...
    class APShot : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            if (Main.netMode != NetmodeID.Server)
            {
                ...
                if (option == 0)
                {
                    Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("Sounds/Custom/RicochetUno") with { Volume = 0.6f, PitchVariance = 0.3f }, Projectile.Center);;
                }
                else if (option == 1)
                {
                    Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("Sounds/Custom/RicochetDos") with { Volume = 0.6f, PitchVariance = 0.3f }, Projectile.Center);
                }
                else if (option == 2)
                {
                    Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("Sounds/Custom/RicochetTres") with { Volume = 0.6f, PitchVariance = 0.3f }, Projectile.Center);
                }
            }
        }
    }
