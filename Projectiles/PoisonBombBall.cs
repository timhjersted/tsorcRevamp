                ...
                if (Main.player[projectile.owner].channel) {
                    ...
                    if (projectile.ai[0] == 0f) {
                        ...
                        if (projectile.velocity.X == 0f && projectile.velocity.Y == 0f) {
                            projectile.Kill();
                            Projectile.NewProjectile(projectile.position.X + projectile.width, projectile.position.Y + projectile.height, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width * 4, projectile.position.Y + projectile.height, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width * -2, projectile.position.Y + projectile.height, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width, projectile.position.Y + projectile.height * 4, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width * 4, projectile.position.Y + projectile.height * 4, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width * -2, projectile.position.Y + projectile.height * 4, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width, projectile.position.Y + projectile.height * -2, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width * 4, projectile.position.Y + projectile.height * -2, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                            Projectile.NewProjectile(projectile.position.X + projectile.width * -2, projectile.position.Y + projectile.height * -2, 0, 0, ModContent.ProjectileType<PoisonField>(), 15, 1f, projectile.owner);
                        }
                    }
                }
            }
