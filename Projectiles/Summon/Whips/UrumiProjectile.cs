...
namespace tsorcRevamp.Projectiles.Summon.Whips
{
	public class UrumiProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Dust.NewDust(Projectile.WhipPointsForCollision[points.Count - 1], 10, 10, DustID.Iron, 0f, 0f, 150, default(Color), 0.5f);
		...
		{
			target.AddBuff(ModContent.BuffType<Buffs.Summon.WhipDebuffs.UrumiDebuff>(), (int)(4 * 60 * Main.player[Projectile.owner].GetModPlayer<tsorcRevampPlayer>().SummonTagDuration));
