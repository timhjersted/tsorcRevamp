...
{
    public class DetonationSignalTrail : DynamicTrail
    {
        ...
        public override void AI()
        {
            ...
            Projectile Whip;
            int? ProjID = UsefulFunctions.GetClosestPlayerProjectile(player.Center, ModContent.ProjectileType<DetonationSignalProjectile>(), player.whoAmI);
            if (ProjID == null)
            {
                return;
            }
            ...
            Color TrailColor = new Color(1.0f, 0.21f, 0.13f, 0.3f);
        ...
        {
            target.AddBuff(ModContent.BuffType<DetonationSignalDebuff>(), ModdedWhipProjectile.DefaultWhipDebuffDuration * 60);
        }
