...
namespace tsorcRevamp.Projectiles.Summon.Whips
{
	public class NightsCrackerProjectile : ModProjectile
	{
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            modifiers.SourceDamage *= MathF.Max(ChargeTime / (MaxChargeTime / 3.85f), 1f);
            modifiers.Knockback *= MathF.Max(ChargeTime / (MaxChargeTime / 3.85f), 1f);
            Vector2 WhipTip = new Vector2(11, 17) * Main.player[Main.myPlayer].whipRangeMultiplier * Projectile.WhipSettings.RangeMultiplier * player.GetModPlayer<tsorcRevampPlayer>().WhipCritHitboxSize;
            List<Vector2> points = Projectile.WhipPointsForCollision;
