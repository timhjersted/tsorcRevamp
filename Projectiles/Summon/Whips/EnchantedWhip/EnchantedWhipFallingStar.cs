...
{
    public class EnchantedWhipFallingStar : DynamicTrail
    {
        public const int ExtraUpdates = 4;
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = 180 * ExtraUpdates;
            Projectile.width = 22;
        ...
        public override void SetEffectParameters(Effect effect)
        {
            ...
            effect.Parameters["shaderColor"].SetValue(new Color(1f, 0.5f, 0f, 1f).ToVector4());
