...
namespace tsorcRevamp.Projectiles.Summon.Whips
{
	public class SearingLashProjectile : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			Projectile.WhipSettings.RangeMultiplier = 1.3f; //only thing affecting the actual whip range
		}
		...
		{
			target.AddBuff(ModContent.BuffType<Buffs.Summon.SearingLashDebuff>(), 240);
