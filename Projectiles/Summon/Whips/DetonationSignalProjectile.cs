...
namespace tsorcRevamp.Projectiles.Summon.Whips
{
	public class DetonationSignalProjectile : ModProjectile
	{
		...
		public override void SetDefaults()
		{
			...
			Projectile.WhipSettings.RangeMultiplier = 1.9f; //only thing affecting the actual whip range
		}
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
		{
            ...
            Vector2 WhipTip = new Vector2(18, 24) * Main.player[Main.myPlayer].whipRangeMultiplier * Projectile.WhipSettings.RangeMultiplier * player.GetModPlayer<tsorcRevampPlayer>().WhipCritHitboxSize;
            List<Vector2> points = Projectile.WhipPointsForCollision;
        ...
        {
            target.AddBuff(ModContent.BuffType<Buffs.Summon.WhipDebuffs.DetonationSignalDebuff>(), (int)(4 * 60 * Main.player[Projectile.owner].GetModPlayer<tsorcRevampPlayer>().SummonTagDuration));
