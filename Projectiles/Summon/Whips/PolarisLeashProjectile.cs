...
namespace tsorcRevamp.Projectiles.Summon.Whips
{
	public class PolarisLeashProjectile : ModProjectile
	{
        ...
        public override void ModifyHitNPC(NPC target, ref NPC.HitModifiers modifiers)
        {
            ...
            Vector2 WhipTip = new Vector2(22, 36) * Main.player[Main.myPlayer].whipRangeMultiplier * Projectile.WhipSettings.RangeMultiplier * player.GetModPlayer<tsorcRevampPlayer>().WhipCritHitboxSize;
            List<Vector2> points = Projectile.WhipPointsForCollision;
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
		{
            ...
            Main.player[Projectile.owner].AddBuff(ModContent.BuffType<PolarisLeashBuff>(), (int)(10 * 60 * Main.player[Projectile.owner].GetModPlayer<tsorcRevampPlayer>().SummonTagDuration)); //Star inflicts the whips debuff
