...
{
	public class PolarisLeashProjectile : ModdedWhip
	{
        ...
        {
            Main.player[Projectile.owner].AddBuff(ModContent.BuffType<PolarisLeashBuff>(), (int)(PolarisLeash.BuffDuration * 60 * Main.player[Projectile.owner].GetModPlayer<tsorcRevampPlayer>().SummonTagDuration)); //Star inflicts the whips debuff
        }
