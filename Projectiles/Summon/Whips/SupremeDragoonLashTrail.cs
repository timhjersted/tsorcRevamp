...
{
    public class SupremeDragoonLashTrail : DynamicTrail
    {
        ...
        public override void AI()
        {
            ...
            Projectile Whip;
            int? ProjID = UsefulFunctions.GetClosestPlayerProjectile(player.Center, ModContent.ProjectileType<SupremeDragoonLashProjectile>(), player.whoAmI);
            if (ProjID == null)
            {
                return;
            }
            ...
            Color TrailColor = new Color(0.42f, 0.1f, 0.9f, 0.3f);
        ...
        {
            Color TrailColor = new Color(0.4f, 0.1f, 0.9f, 0.3f);
        ...
        {
            target.AddBuff(ModContent.BuffType<SupremeDragoonLashDebuff>(), ModdedWhipProjectile.DefaultWhipDebuffDuration * 60);
        }
