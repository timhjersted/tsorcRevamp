...
namespace tsorcRevamp.Projectiles.Summon.Whips
{
	public class PyrosulfateProjectile : ModProjectile
	{
		...
		public override void AI()
		{
			...
			Dust.NewDust(Projectile.WhipPointsForCollision[points.Count - 1], 10, 10, DustID.SilverFlame, 0f, 0f, 150, Color.Green, 1f);
			Dust.NewDust(Projectile.WhipPointsForCollision[points.Count - 1], 10, 10, DustID.CursedTorch, 0f, 0f, 150, default(Color), 1f);
		...
		{
			target.AddBuff(ModContent.BuffType<Buffs.Summon.WhipDebuffs.PyrosulfateDebuff>(), (int)(4 * 60 * Main.player[Projectile.owner].GetModPlayer<tsorcRevampPlayer>().SummonTagDuration));
