...
{
    public class PyrosulfateProjectile : ModdedWhipProjectile
    {
        ...
        public override Color DustColor => Color.Green;
        ...
        {
            target.AddBuff(BuffID.CursedInferno, WhipDebuffDuration * 60);
        }
