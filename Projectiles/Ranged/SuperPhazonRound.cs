    ...
    class SuperPhazonRound : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            if (Main.rand.Next(0, 4) == 0)
            {
                ...
                Dust.NewDustPerfect(Projectile.position, DustID.FireworkFountain_Blue, (Projectile.velocity * 0.6f) + Main.rand.NextVector2Circular(speed, speed), 200, default, 1.1f).noGravity = true;
            }
        }
        ...
        public override bool PreKill(int timeLeft)
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                Dust.NewDustPerfect(Projectile.position, DustID.FireworkFountain_Blue, (Projectile.velocity * Main.rand.NextFloat(0, 0.8f)) + Main.rand.NextVector2Circular(speed, speed), 200, default, 1.5f).noGravity = true;
            }
            return true;
        }
