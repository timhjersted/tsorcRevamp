    ...
    class GWPulsarShot : ModProjectile
    {
        ...
        public override bool OnTileCollide(Vector2 oldVelocity)
        {
            if (Projectile.owner == Main.myPlayer && Projectile.timeLeft >= 97)
            {
                ...
                {
                    Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("tsorcRevamp/Sounds/Item/PulsarBump") with { Volume = 0.6f, PitchVariance = 0.3f }, Projectile.Center);
                }
            }
        ...
        public override void AI()
        {
            ...
            if (Projectile.owner == Main.myPlayer && Projectile.timeLeft == 96)
            {
                if (Main.netMode != NetmodeID.Server)
                {
                    Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("tsorcRevamp/Sounds/Item/PulsarGrow") with { Volume = 0.6f, PitchVariance = 0.3f }, Projectile.Center);
                }
            }
