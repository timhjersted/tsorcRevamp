...
class ArcheologistWhip : ModProjectile
{
    ...
    public override void AI()
    {
        ...
        {
            Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("tsorcRevamp/Sounds/Custom/WhipCrack") with { Volume = 0.6f, PitchVariance = 0.3f }, Projectile.Center);
        }
