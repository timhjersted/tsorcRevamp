...
namespace tsorcRevamp.Projectiles {
    class Bolt2Ball : ModProjectile {
        ...
        public override void Kill(int timeLeft) {
            Projectile.NewProjectile(projectile.position.X + projectile.width / 2, projectile.position.Y + projectile.height / 2, projectile.velocity.X, projectile.velocity.Y, ModContent.ProjectileType<Bolt2Bolt>(), projectile.damage, 8f, projectile.owner);
        }
    }
