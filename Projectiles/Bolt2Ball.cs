...
namespace tsorcRevamp.Projectiles {
    class Bolt2Ball : ModProjectile {
        ...
        public override void Kill(int timeLeft) {
            Projectile.NewProjectile(projectile.position.X + (float)(projectile.width / 2), projectile.position.Y + (float)(projectile.height / 2), 0, 0, ModContent.ProjectileType<Bolt2Bolt>(), (int)(this.projectile.damage), 8f, projectile.owner);
        }
    }
