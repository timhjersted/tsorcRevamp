    ...
    public class tsorcRevamp : Mod
    {
        ...
        private void PopulateArrays()
        {
            ...
            KillAllowed = new List<int>() {
                ...
                TileID.ShadowOrbs, TileID.CorruptThorns, TileID.JungleThorns, TileID.CrimsonThorns, TileID.Sand, 116, TileID.Ebonsand, TileID.Crimsand, TileID.LandMine, TileID.RollingCactus, //orbs/hearts, all thorns, all sands, land mines, rolling cactus
    ...
    public static class TransparentTextureHandler
    {
        ...
        public static void TransparentTextureFix()
        {
            ...
            TransparentTextures = new Dictionary<TransparentTextureType, Texture2D>()
            {
                ...
                {TransparentTextureType.PulsarGlowmask, (Texture2D)ModContent.Request<Texture2D>("tsorcRevamp/Items/Weapons/Ranged/Pulsar_Glowmask", AssetRequestMode.ImmediateLoad)},
                {TransparentTextureType.GWPulsarGlowmask, (Texture2D)ModContent.Request<Texture2D>("tsorcRevamp/Items/Weapons/Ranged/GWPulsar_Glowmask", AssetRequestMode.ImmediateLoad)},
                {TransparentTextureType.PolarisGlowmask, (Texture2D)ModContent.Request<Texture2D>("tsorcRevamp/Items/Weapons/Ranged/Polaris_Glowmask", AssetRequestMode.ImmediateLoad)},
                {TransparentTextureType.ToxicCatalyzerGlowmask, (Texture2D)ModContent.Request<Texture2D>("tsorcRevamp/Items/Weapons/Ranged/ToxicCatalyzer_Glowmask", AssetRequestMode.ImmediateLoad)},
                {TransparentTextureType.VirulentCatalyzerGlowmask, (Texture2D)ModContent.Request<Texture2D>("tsorcRevamp/Items/Weapons/Ranged/VirulentCatalyzer_Glowmask", AssetRequestMode.ImmediateLoad)},
