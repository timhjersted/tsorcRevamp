    ...
    public class SoulSkellyR : ModTile
    {
        ...
        public override void PostDraw(int i, int j, SpriteBatch spriteBatch)
        {
            ...
            if (tile.TileFrameX / 54 == 0)
            {
                ...
                Main.spriteBatch.Draw(Mod.GetTexture("Tiles/SoulSkellyR_Glow"), new Vector2(i * 16 - (int)Main.screenPosition.X, j * 16 - (int)Main.screenPosition.Y) + zero, new Rectangle(tile.TileFrameX, tile.TileFrameY, 16, height), Color.White, 0f, Vector2.Zero, 1f, SpriteEffects.None, 0f);
            }
        }
        public override void MouseOver(int i, int j)
        {
            ...
            if (tile.TileFrameX / 54 == 0)
            {
                ...
                player.cursorItemIconID = ModContent.ItemType<SoulSkellyItemR>();
            }
        }
        ...
        public override bool RightClick(int i, int j)
        {
            ...
            if (tile.TileFrameX / 54 == 0)
            {
                Terraria.Audio.SoundEngine.PlaySound(SoundID.NPCDeath52 with { Volume = 0.35f }.WithPitchVariance(.3f)); // Plays sound.
