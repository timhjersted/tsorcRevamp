...
namespace tsorcRevamp.Tiles.Relics
{
    ...
    public abstract class RelicTile : ModTile
    {
        ...
        public abstract string RelicTextureFileName { get; }
        public virtual string RelicTextureFilePath => "tsorcRevamp/Tiles/Relics/" + RelicTextureFileName;

        // All relics use the same pedestal texture, this one is copied from vanilla
        public override string Texture => "tsorcRevamp/Tiles/Relics/0RelicTile";
        ...
        public override void Load()
        {
            if (!Main.dedServ)
            {
                ...
                RelicTexture = ModContent.Request<Texture2D>(RelicTextureFilePath);
            }
        }
