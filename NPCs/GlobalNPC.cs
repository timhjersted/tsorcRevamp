    ...
    class tsorcRevampGlobalNPC : GlobalNPC {
        ...
        public override void NPCLoot(NPC npc) {
            ...
            if (npc.lifeMax > 5 && npc.value >= 10f) { //stop zero-value souls from dropping
                ...
                if ((enemyValue >= 50) && (enemyValue <= 5000) && (Main.rand.NextFloat() < .015f) && Main.hardMode && npc.type != NPCID.JungleSlime) // 1.5% chance of all enemies between enemyValue 50 and 5000 dropping ProudKnightSoul aka 1/75
                {
