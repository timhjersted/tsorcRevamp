...
namespace tsorcRevamp.NPCs.Friendly
{
    class Chicken : ModNPC
    {
        ...
        {
            if (!Main.dedServ && (Main.rand.Next(360) == 0)) Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("Sounds/Custom/ChickenBokbok") with { Volume = 0.8f, Pitch = 0.3f }, NPC.Center);
        }
