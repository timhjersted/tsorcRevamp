...
namespace tsorcRevamp.NPCs.Friendly
{
    class Chicken : ModNPC
    {
        ...
        {
            if (!Main.dedServ && (Main.rand.Next(360) == 0)) Terraria.Audio.SoundEngine.PlaySound(new Terraria.Audio.SoundStyle("Sounds/Custom/ChickenBokbok").WithVolume(.8f).WithPitchVariance(.3f), NPC.Center);
        }
