...
{
    // Pre-Phase-3-migration backup of HollowSpearman (bespoke jump-ladder movement). Kept for A/B reference;
    // reuses HollowSpearman's sprite. The live HollowSpearman now runs the shared FighterAI + SF4 nav + poise.
    class HollowSpearmanOriginal : ModNPC
    {
        public override string Texture => "tsorcRevamp/NPCs/Enemies/HollowSpearman";
