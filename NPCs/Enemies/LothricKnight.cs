...
namespace tsorcRevamp.NPCs.Enemies
{
    public class LothricKnight : ModNPC //Don't look at the code, it's muy malo. Look at Lothric Spear Knight for a better example code management-wise
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (tsorcRevampWorld.SuperHardMode && !(spawnInfo.player.ZoneJungle || spawnInfo.player.ZoneHoly || spawnInfo.player.ZoneCorrupt || spawnInfo.player.ZoneCrimson || spawnInfo.player.ZoneSnow || spawnInfo.player.ZoneBeach || spawnInfo.player.ZoneSkyHeight || spawnInfo.player.ZoneUnderworldHeight)) return 0.03f;
        ...
        public override void NPCLoot()
        {
            ...
            if (Main.rand.Next(10) == 0 && Main.hardMode) Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Potions.RadiantLifegem>());
