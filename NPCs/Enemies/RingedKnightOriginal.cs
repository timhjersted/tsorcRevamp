...
{
    // Pre-port backup of RingedKnight (bespoke jump-ladder movement + hand-rolled boredom/lava teleport + flamethrower).
    // Kept for reference/comparison against the SF4 + poise/stagger port. Shares the RingedKnight spritesheet & banner.
    public class RingedKnightOriginal : ModNPC //Do I win the award for messiest code 2022 yet?
    {
        public override string Texture => "tsorcRevamp/NPCs/Enemies/RingedKnight";
        ...
        {
            npcLoot.Add(ItemDropRule.ByCondition(tsorcRevamp.tsorcItemDropRuleConditions.CursedRule, ModContent.ItemType<RadiantLifegemItem>(), 6));
