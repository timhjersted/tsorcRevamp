...
{
    // Pre-Phase-3-migration backup of HollowSoldier (bespoke jump-ladder movement). Kept for A/B reference;
    // reuses HollowSoldier's sprite. The live HollowSoldier now runs the shared FighterAI + SF4 nav + poise.
    public class HollowSoldierOriginal : ModNPC //Don't look at the code, it's muy malo. Look at Lothric Spear Knight for a better example code management-wise
    {
        public override string Texture => "tsorcRevamp/NPCs/Enemies/HollowSoldier";
        ...
        {
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SoulCoin>(), 1, 3, 9));
