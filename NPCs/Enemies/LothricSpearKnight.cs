...
namespace tsorcRevamp.NPCs.Enemies
{
    class LothricSpearKnight : ModNPC
    {
        ...
        public override float SpawnChance(NPC.Spawner spawner)
        {
            ...
            if (tsorcRevampWorld.SuperHardMode && !(spawner.Player.ZoneJungle || spawner.Player.ZoneHallow || spawner.Player.ZoneCorrupt || spawner.Player.ZoneCrimson || spawner.Player.ZoneSnow || spawner.Player.ZoneBeach || spawner.Player.ZoneSkyHeight || spawner.Player.ZoneUnderworldHeight)) return 0.02f;
            if (tsorcRevampWorld.SuperHardMode && spawner.Player.ZoneDungeon) return 0.05f;
            ...
            if (NPC.downedBoss3 && spawner.Player.ZoneOverworldHeight && !spawner.Player.ZoneSkyHeight && Main.dayTime && !spawner.Player.ZoneJungle) return chance = 0.005f;
            if (NPC.downedBoss3 && spawner.Player.ZoneOverworldHeight && !spawner.Player.ZoneSkyHeight && !Main.dayTime && !spawner.Player.ZoneJungle) return chance = 0.015f;
            if (NPC.downedBoss3 && !(spawner.Player.ZoneJungle || spawner.Player.ZoneHallow || spawner.Player.ZoneCorrupt || spawner.Player.ZoneCrimson || spawner.Player.ZoneSnow || spawner.Player.ZoneBeach || spawner.Player.ZoneSkyHeight || spawner.Player.ZoneUnderworldHeight)) return chance = 0.003f;
