	...
	class TibianAmazon : ModNPC
	{
		...
		public override void HitEffect(int hitDirection, double damage)
		{
			...
			if (NPC.life <= 0)
			{
				...
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, new Vector2(Main.rand.Next(-30, 31) * 0.2f, Main.rand.Next(-30, 31) * 0.2f), Mod.GetGoreSlot("Gores/Tibian Amazon Gore 1"), 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, new Vector2(Main.rand.Next(-30, 31) * 0.2f, Main.rand.Next(-30, 31) * 0.2f), Mod.GetGoreSlot("Gores/Tibian Amazon Gore 2"), 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, new Vector2(Main.rand.Next(-30, 31) * 0.2f, Main.rand.Next(-30, 31) * 0.2f), Mod.GetGoreSlot("Gores/Tibian Amazon Gore 3"), 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, new Vector2(Main.rand.Next(-30, 31) * 0.2f, Main.rand.Next(-30, 31) * 0.2f), Mod.GetGoreSlot("Gores/Tibian Amazon Gore 2"), 1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, new Vector2(Main.rand.Next(-30, 31) * 0.2f, Main.rand.Next(-30, 31) * 0.2f), Mod.GetGoreSlot("Gores/Tibian Amazon Gore 3"), 1f);
			}
		}
