...
namespace tsorcRevamp.NPCs.Enemies
{
    public class JungleSentree : ModNPC // Source of rich mahogany - drops extra wood when hit with axe - takes 2x damage from axes
    {
        ...
        public override void AI()
        {
            ...
            NPC.GivenName = LangUtils.GetTextValue("NPCs.JungleSentree.GivenName1");
            ...
            {
                NPC.GivenName = LangUtils.GetTextValue("NPCs.JungleSentree.GivenName2");
        ...
        public override void ModifyHitByItem(Player player, Item item, ref NPC.HitModifiers modifiers)
        {
            ...
            //fire melee
            if (player.HasBuff(BuffID.WeaponImbueFire) || item.type == ModContent.ItemType<AncientFireSword>() || item.type == ModContent.ItemType<AncientFireAxe>() || item.type == ModContent.ItemType<AncientFireAxeShort>()
