...
namespace tsorcRevamp.NPCs.Enemies.SuperHardMode
{
	class CrystalKnight : ModNPC
	{
		...
		public override void OnKill()
		{
			...
			if (NPC.life <= 0)
			{
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Crystal Knight Gore 1"), 1.1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Crystal Knight Gore 2"), 1.1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Crystal Knight Gore 2"), 1.1f);
				Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Crystal Knight Gore 2"), 1.1f);
