...
namespace tsorcRevamp.NPCs.Enemies.SuperHardMode
{
    class CrystalKnight : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            tsorcRevampAIs.ArcherAI(NPC, ModContent.ProjectileType<Projectiles.Enemy.EnemyCrystalKnightBolt>(), crystalBoltDamage, 14, 70, 2, 0.07f, canTeleport: true, lavaJumping: true, shootSound: SoundID.Item30);
        }
