...
namespace tsorcRevamp.NPCs.Enemies.SuperHardMode
{
	class CorruptedHornet : ModNPC
	{
		...
		{
			Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Corrupt Hornet Gore 1"), 1.1f);
			Gore.NewGore(NPC.GetSource_Death(), NPC.position, NPC.velocity, Mod.Find<ModGore>("Gores/Corrupt Hornet Gore 2"), 1.1f);
