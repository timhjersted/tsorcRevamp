...
namespace tsorcRevamp.NPCs.Enemies.SuperHardMode
{
    class TaurusKnight : ModNPC
    {
        ...
        public override void AI()  //  warrior ai
        {
            ...
            float acceleration = .01f;  //  how fast it can speed up
            float top_speed = 0.6f;  //  max walking speed, also affects jump length
        ...
        public override void NPCLoot()
        {
            ...
            if (Main.rand.Next(99) < 50) Item.NewItem(npc.getRect(), ModContent.ItemType<Items.Humanity>());
