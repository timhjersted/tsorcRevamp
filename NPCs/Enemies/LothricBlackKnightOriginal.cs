...
{
    // Pre-port backup of LothricBlackKnight (bespoke jump-ladder movement + hand-rolled enrage).
    // Kept for A/B reference; the live LothricBlackKnight now runs the shared FighterAI + SF4 nav + poise.
    public class LothricBlackKnightOriginal : ModNPC
    {
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            npcLoot.Add(ItemDropRule.Common(ModContent.ItemType<SoulCoin>(), 1, 36, 42));
        }
