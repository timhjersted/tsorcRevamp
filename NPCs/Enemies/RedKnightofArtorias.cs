...
{
    class RedKnightofArtorias : ModNPC
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Red Knight of Artorias");
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (!P.ZoneMeteor && !P.ZoneDungeon && !(P.ZoneCorrupt || P.ZoneCrimson) && P.ZoneOverworldHeight && Main.hardMode && !Main.dayTime && Main.rand.Next(6000) == 1) return 1;

            if (Main.hardMode && P.ZoneMeteor && !(P.ZoneCorrupt || P.ZoneCrimson) && P.ZoneDirtLayerHeight && Main.rand.Next(1650) == 1) return 1;

            if (Main.hardMode && !Main.dayTime && P.ZoneDungeon && !(P.ZoneCorrupt || P.ZoneCrimson) && P.ZoneRockLayerHeight && Main.rand.Next(3000) == 1) return 1;

            if (Main.hardMode && P.ZoneUnderworldHeight && !Main.dayTime && Main.rand.Next(700) == 1) return 1;
