...
namespace tsorcRevamp.NPCs.Bosses.Serris
{
    ...
    class SerrisHead : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            {
                despawnHandler = new NPCDespawnHandler(LaUtils.GetTextValue("NPCs.SerrisHead.DespawnHandler"), Color.Cyan, DustID.Firework_Blue);
            }
        }
        ...
        public override void OnKill()
        {
            ...
            if (!(NPC.CountNPCS(ModContent.NPCType<NPCs.Bosses.Serris.SerrisHead>()) > 1))
            {
                UsefulFunctions.BroadcastText(LaUtils.GetTextValue("NPCs.Serris.Transform"), Color.Cyan);
