...
namespace tsorcRevamp.NPCs.Bosses.Serris
{
    ...
    class SerrisHead : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            {
                despawnHandler = new NPCDespawnHandler(LangUtils.GetTextValue("NPCs.SerrisHead.DespawnHandler"), Color.Cyan, DustID.Firework_Blue);
            }
        }
        ...
        public override void AI()
        {
            ...
            else
            {
                ...
                if (Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    Terraria.Audio.SoundEngine.PlaySound(SoundID.Item91 with { Volume = 0.55f, Pitch = -0.8f }, NPC.Center);
                }
            }
