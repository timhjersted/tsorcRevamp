...
namespace tsorcRevamp.NPCs.Bosses
{
    ...
    class GreatRedThresher : ModNPC
    {
        ...
        public override void AI()
        {
            ...
            if (Vector2.Distance(NPC.Center, Main.player[NPC.target].Center) > 2000)
            {
            ...
            if (!slograDead)
            {
                if (!NPC.AnyNPCs(ModContent.NPCType<GreatRedKnight>()))
                {
                    slograDead = true;
                }
            }
