        ...
        public override void AI()
        {
            ...
            if (Timer >= 600)
            {
                if (Main.netMode != 2)
                {
                    ...
                    int num54 = Projectile.NewProjectile(NPC.GetSource_FromThis(), vector8.X, vector8.Y, (float)((Math.Cos(rotation) * num48) * -1), (float)((Math.Sin(rotation) * num48) * -1), ProjectileID.LostSoulHostile, fireDamage, 0f, Main.myPlayer);//ModContent.ProjectileType<Projectiles.Enemy.PoisonCrystalFire>()
