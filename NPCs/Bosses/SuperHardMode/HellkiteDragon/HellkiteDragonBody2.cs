...
{
    class HellkiteDragonBody2 : ModNPC
    {
        ...
        public override void OnKill()
        {
            ...
            {
                Gore.NewGore(NPC.GetSource_Death(), vector8, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), Mod.GetGoreSlot("Gores/Hellkite Dragon Body Gore 2"), 1f);
            }
        }
    }
}