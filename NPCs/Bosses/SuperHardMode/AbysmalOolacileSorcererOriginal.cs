...
namespace tsorcRevamp.NPCs.Bosses.SuperHardMode
{
    ...
    /// </summary>
    [AutoloadBossHead]
    class AbysmalOolacileSorcererOriginal : ModNPC
    {
        ...
        public override float SpawnChance(NPCSpawnInfo spawnInfo)
        {
            ...
            if (tsorcRevampWorld.SuperHardMode && !Main.dayTime && tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<Witchking>())) && !tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<AbysmalOolacileSorcererOriginal>())) && AboveEarth && Main.rand.NextBool(200)) return 1;

            if (tsorcRevampWorld.SuperHardMode && !Main.dayTime && tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<Witchking>())) && !tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<AbysmalOolacileSorcererOriginal>())) && InBrownLayer && Main.rand.NextBool(500)) return 1;

            if (tsorcRevampWorld.SuperHardMode && Main.bloodMoon && tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<Witchking>())) && !tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<AbysmalOolacileSorcererOriginal>())) && AboveEarth && Main.rand.NextBool(50)) return 1;

            if (tsorcRevampWorld.SuperHardMode && Main.bloodMoon && tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<Witchking>())) && tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<AbysmalOolacileSorcererOriginal>())) && !tsorcRevampWorld.NewSlain.ContainsKey(new NPCDefinition(ModContent.NPCType<Artorias>())) && AboveEarth && Main.rand.NextBool(2850)) return 1;
