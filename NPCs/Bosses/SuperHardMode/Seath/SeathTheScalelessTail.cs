...
{
    class SeathTheScalelessTail : ModNPC
    {
        ...
        public override void OnKill()
        {
            if (NPC.life <= 0)
            {
                ...
                Gore.NewGore(NPC.GetSource_Death(), vector8, new Vector2((float)Main.rand.Next(-30, 31) * 0.2f, (float)Main.rand.Next(-30, 31) * 0.2f), Mod.Find<ModGore>("Gores/Seath the Scaleless Body Gore 2").Type, 1f);
            }
        }
    }
}