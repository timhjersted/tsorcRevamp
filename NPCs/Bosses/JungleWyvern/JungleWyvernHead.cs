...
namespace tsorcRevamp.NPCs.Bosses.JungleWyvern
{
    ...
    class JungleWyvernHead : ModNPC
    {
        ...
        public override void SetDefaults()
        {
            ...
            NPC.boss = true;
            NPC.value = 113490;
            despawnHandler = new NPCDespawnHandler(LaUtils.GetTextValue("NPCs.JungleWyvernHead.DespawnHandler"), Color.GreenYellow, DustID.GreenFairy);
        }
        ...
        public override void AI()
        {
            ...
            if (breathCD <= 0)
            {
                breath = false;
                breathCD = 100;
                Terraria.Audio.SoundEngine.PlaySound(SoundID.Item34); //Item20 = flame, Item34 = flamethrower / breath
            }
