...
float4 PixelShaderFunction(float4 sampleColor : COLOR0, float2 coords : TEXCOORD0) : COLOR0
{
    ...
    float4 laserColor = float4(0.02, 0.18, 0.20, 1.0);
    float4 white = float4(0.01,0.01,0.01,1.0);
    ...
    effectColor = effectColor * centerIntensity * (pow(intensity, 8.0)) * 14.5;
...
technique CursedFireball
{
    pass CursedFireballPass
    {
