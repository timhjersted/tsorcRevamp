...
float4 PixelShaderFunction(float4 sampleColor : COLOR0, float2 coords : TEXCOORD0) : COLOR0
{
    ...
    float progress = ringProgress * 0.70;
    ...
    return effectColor * fade * sampleIntensity * 1.75 * ringDistance / distanceIntensity;
}


technique AttraidiesShield
{
    pass AttraidiesShieldPass
    {
