...
namespace tsorcRevamp
{
    public static class tsorcScriptedEvents
    {
        ...
        public static void InitializeScriptedEvents()
        {
            ...
            ScriptedEvent RuneMage = new ScriptedEvent(new Vector2(3897, 1219), 20, ModContent.NPCType<RuneMage>(), 27, true, true, true, "lol black knight", Color.Blue, false, default);
            ...
            ScriptedEventDict = new Dictionary<ScriptedEventType, ScriptedEvent>(){
                ...
                {ScriptedEventType.RuneMage, RuneMage},
