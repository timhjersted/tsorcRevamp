...
namespace tsorcRevamp.Items.Materials
{
    ...
    {
        public override string Texture => "tsorcRevamp/Items/Materials/SoulOfDark";
        public override void SetStaticDefaults()
        {
            Main.RegisterItemAnimation(Item.type, new DrawAnimationVertical(5, 4));
            ItemID.Sets.AnimatesAsSoul[Item.type] = true;
    ...
    {
        public override string Texture => "tsorcRevamp/Items/Materials/SoulOfGuardian";
        public override void SetStaticDefaults()
        {
    ...
    {
        public override string Texture => "tsorcRevamp/Items/Materials/SoulOfBequeathed";
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
    ...
    {
        public override string Texture => "tsorcRevamp/Items/Materials/SoulOfCursed";
        public override void SetStaticDefaults()
        {
            base.SetStaticDefaults();
