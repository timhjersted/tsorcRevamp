...
namespace tsorcRevamp.Items.Weapons
{
    public class DebugTome : ModItem
    {
        ...
        {            
            ...
            Projectile.NewProjectile(player.GetSource_ItemUse(Item), player.Center, speed, ModContent.ProjectileType<Projectiles.PrimTrailTest>(), damage, knockBack, Main.myPlayer);
