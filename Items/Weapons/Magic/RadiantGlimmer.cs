...
namespace tsorcRevamp.Items.Weapons.Magic
{
    ...
    public class PsuedoDust
    {
        ...
        //Its size, which is also its lifetime
        public float size;

        //What type of dust should it spawn?
        public int type;

        //What style of dust should it spawn?
        public int style;

        //What color should it be lit?
        public Color color;
        ...
        public Rectangle Frame()
        {
            ...
            int frameY = (30 * (int)Math.Floor(type / 100f)) + (10 * style);
            return new Rectangle(frameX, frameY, 10, 10);
        }

        public void Draw(SpriteBatch spriteBatch)
        {
            spriteBatch.Draw((Texture2D)Terraria.GameContent.TextureAssets.Dust, center - Main.screenPosition - new Vector2(350, 160), Frame(), color, rotation, new Vector2(5, 5), size, SpriteEffects.None, rotation);
        }
    }
