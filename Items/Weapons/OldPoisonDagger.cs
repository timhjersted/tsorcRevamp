...
namespace tsorcRevamp.Items.Weapons
{
    class OldPoisonDagger : ModItem
    {
        ...
        public override void MeleeEffects(Player player, Rectangle hitbox)
        {
            ...
            {
                int dust = Dust.NewDust(new Vector2(hitbox.X, hitbox.Y), hitbox.Width, hitbox.Height, DustID.ToxicBubble, player.velocity.X * 1.2f + (float)(player.direction * 1.2f), player.velocity.Y * 1.2f, 100, default(Color), 1.2f);
