...
namespace tsorcRevamp.Items.BossItems {
    class DyingWaterCrystal : ModItem {
        ...
        public override bool UseItem(Player player) {
            ...
            //NPC.SpawnOnPlayer(player.whoAmI, ModContent.NPCType<NPCs.Bosses.Kraken>());
            return true;
        }
        public override bool CanUseItem(Player player) {
            return !(NPC.AnyNPCs(NPCID.CorruptBunny));
            //todo fix placeholder
            //return (!NPC.AnyNPCs(ModContent.NPCType<NPCs.Bosses.Kraken>()));
        }

        public override void AddRecipes() {
            ModRecipe recipe = new ModRecipe(mod);
            recipe.AddIngredient(ItemID.Sapphire, 300);
