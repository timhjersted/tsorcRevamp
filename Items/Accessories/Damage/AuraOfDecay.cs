...
namespace tsorcRevamp.Items.Accessories.Damage
{
    public class AuraOfDecay : ModItem
    {
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            {
                Projectile.NewProjectile(player.GetSource_Accessory(Item), player.Center, Vector2.Zero, ModContent.ProjectileType<Projectiles.AuraOfDecay>(), 265, 0, Main.myPlayer, player.whoAmI);
            }
        }
