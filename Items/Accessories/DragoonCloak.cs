...
namespace tsorcRevamp.Items.Accessories
{
    ...
    {
        public static float LifeThreshold = (LightCloak.LifeThreshold + ShadowmoonCloak.LifeThreshold + DarkCloak.LifeThreshold) / 3;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<ShadowmoonCloak>());
        ...
        public override void UpdateEquip(Player player)
        {
            ...
            if (player.statLife <= (int)(player.statLifeMax2 * (LifeThreshold / 100f)))
            {
                ...
                player.GetDamage(DamageClass.Generic) += ShadowmoonCloak.DamageAndCritIncrease2 / 100f;
